...
<svelte:head>
	<title>Ads Enhanced Conversions | JavaScript</title>
</svelte:head>
<h2 class="w-10/12 lg:w-6/12 mx-auto text-3xl text-center mt-2 pt-6">Ads Enhanced Conversions | JavaScript</h2>
<form
	id="javascript_form"
