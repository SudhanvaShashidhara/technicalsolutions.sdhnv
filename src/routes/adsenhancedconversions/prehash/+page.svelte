...
<svelte:head>
	<title>Ads Enhanced Conversions | Pre Hashed Data</title>
</svelte:head>
<h2 class="w-10/12 lg:w-6/12 mx-auto text-3xl text-center mt-2 pt-6">Ads Enhanced Conversions | Pre Hashed Data</h2>
<form
...
>
	<div class="space-y-12">
		<div class="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-3">
			<div class="relative overflow-hidden py-10 px-6 sm:px-10 xl:p-12 bg-googlegreycore rounded-md">
			...
			<div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
				<div class="col-start-2 sm:col-span-7">
					...
					<div class="mt-2">
						<input
							...
							class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-googlegreycore sm:text-sm sm:leading-6"
						/>
					</div>
				</div>
				...
				<div class="col-start-2 sm:col-span-7">
					...
					<div class="mt-2">
						<select
							...
							class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-googlegreycore sm:max-w-xs sm:text-sm sm:leading-6"
						>
				...
				<div class="col-start-2 sm:col-span-7">
					...
					<div class="mt-2 sm:col-span-2 sm:mt-0">
						<textarea
							...
							rows="3"
							class="block w-full max-w-2xl rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-googlegreycore sm:text-sm sm:leading-6"
						/>
					</div>
				</div>
				...
				<div class="col-start-2 flex justify-end sm:col-span-7">
					<button
						type="submit"
						class="rounded-md bg-googlegreycore px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-googleyellowG900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-googlebluecore"
						>SUBMIT</button
					>
				</div>
			</div>
