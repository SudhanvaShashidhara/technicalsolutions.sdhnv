<script lang="ts">
	...
	onMount(() => {
		...
		if (window.grecaptcha?.enterprise) {
			...
			loadScript(
				'https://www.google.com/recaptcha/enterprise.js?onload=onRecaptchaV2Load&render=explicit'
			).catch((err) => {
	...
	function handle_submit(e: SubmitEvent) {
		...
		if (window.grecaptcha?.enterprise && widget_id !== null) {
			window.grecaptcha.enterprise.reset(widget_id);
		}
		recaptcha_v2_token = '';
		form.reset();
	}
...
<svelte:head>
	<title>Ads Enhanced Conversions | Automatic</title>
</svelte:head>
<h2 class="w-10/12 lg:w-6/12 mx-auto text-3xl text-center mt-2 pt-6">
	Ads Enhanced Conversions | Automatic
</h2>
<form
	id="automatic_form"
...
>
	<div class="space-y-12">
		<div class="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-3">
			<div
				class="relative overflow-hidden py-10 px-6 sm:px-10 xl:p-12 bg-googlebluecore rounded-md"
			>
			...
			<div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
				<div class="col-start-2 sm:col-span-7">
					...
					<div class="mt-2">
						<input
							...
							class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-googlebluecore sm:text-sm sm:leading-6"
						/>
					</div>
				</div>
				...
				<div class="col-start-2 sm:col-span-7">
					...
					<div class="mt-2">
						<select
							...
							class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-googlebluecore sm:max-w-xs sm:text-sm sm:leading-6"
						>
				...
				<div class="col-start-2 sm:col-span-7">
					...
					<div class="mt-2 sm:col-span-2 sm:mt-0">
						<textarea
							...
							rows="3"
							class="block w-full max-w-2xl rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-googlebluecore sm:text-sm sm:leading-6"
						></textarea>
					</div>
				</div>
				...
				<div class="col-start-2 flex justify-end sm:col-span-7">
					<button
						type="submit"
						class="rounded-md bg-googlebluecore px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-googleblueG900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-googlebluecore"
						>SUBMIT</button
					>
				</div>
			</div>
		...
		<div class="rounded-md py-4 mt-4 px-6 bg-googlegreenG50">
			<div class="flex">
				<div class="flex-shrink-0">
					<svg
						class="h-5 w-5 text-googlegreenG800"
						viewBox="0 0 20 20"
						fill="currentColor"
						aria-hidden="true"
					>
				...
				<div class="ml-auto pl-3">
					<div class="-mx-1.5 -my-1.5">
						<button
							...
							type="button"
							class="inline-flex rounded-md bg-green-50 p-1.5 text-googlegreenG800 hover:bg-googlegreenG50 focus:outline-none focus:ring-2 focus:ring-googlegreenG900 focus:ring-offset-2 focus:ring-offset-green-50"
						>
